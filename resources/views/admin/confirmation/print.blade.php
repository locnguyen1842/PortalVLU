          ...
          <div class="col-sm-10" style="margin-top:2rem">
                ...
                <div class="form-group col-sm-12">
                    ...
                    @endif
                     ...
                     @if($cr->pi->leader_type()->exists())
                        ...
                        @else
                            ...
                            <label class="content" for="">Là <span>{{$cr->pi->officer->position->name}}</span> <span>{{$cr->pi->unit->name}}</span>, Trường Đại học Văn Lang từ {{date('d/m/Y', strtotime($cr->pi->date_of_recruitment))}}
                                đến nay.</label>
                        @endif
                    ...
                    @endif
                     ...
                     <label class="content" for="">Là <span>{{$cr->pi->officer->position->note}}</span> <span>{{$cr->pi->unit->name}}</span>, Trường Đại học Văn Lang từ {{date('d/m/Y', strtotime($cr->pi->date_of_recruitment))}}
                         đến nay.</label>
