            ...
            <tbody>
                ...
                <tr>
                    <td class="col-sm-1">
                        ...
                        <a href="{{route('admin.pi.detail',$item->id)}}" data-toggle="tooltip" data-placement="right"
                    ...
                    <td class="col-sm-3">
                        <a href="{{route('admin.pi.update',$item->id)}}" data-toggle="tooltip" data-placement="top"
                            title="" data-original-title="Cập nhật" href="javascript:" class="tooltip-test">
                            <span class=""><i class="fa fa-lg fa-edit text-primary"></i>
                                <span class="mdi mdi-close"></span>
                            </span>
                        </a>
                        <a href="{{route('admin.pi.delete',$item->id)}}" data-toggle="tooltip" data-placement="top"
