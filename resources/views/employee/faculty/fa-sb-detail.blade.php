                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span for="" class="col-sm-8 text-truncate">{{($sb->getHighestDegree($pi->id)) == null ? '':'năm '. date('Y',strtotime($sb->getHighestDegree($pi->id)->date_of_issue)).', nước '.$sb->getHighestDegree($pi->id)->nation_of_issue_id}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6">
