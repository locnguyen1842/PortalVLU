                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Lý lịch sơ lược<br>
                            ...
                            <a href="{{route('employee.faculty.sb.print',$sb->pi->id)}}" target="_blank">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <span for=""
                                            class="col-sm-8 text-truncate">{{($sb->getHighestDegree($sb->pi->id))== null ? 'Chưa có':($sb->getHighestDegree($sb->pi->id))->degree->name}}</span>
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="inputEmail3" class="col-sm-4">Năm, nước nhận học vị</label>
                                        <span for=""
                                            class="col-sm-8 text-truncate">{{($sb->getHighestDegree($sb->pi->id)) == null ? '':'năm '. date('Y',strtotime($sb->getHighestDegree($sb->pi->id)->date_of_issue)).', nước '.$sb->getHighestDegree($sb->pi->id)->nation_of_issue_id}}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6">
