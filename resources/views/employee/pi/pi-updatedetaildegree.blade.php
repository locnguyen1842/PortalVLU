            ...
            <form class="form-horizontal" action="{{route('employee.pi.update.detail.degree',$degree->id)}}" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        ...
                        <input required type="date" min="1900-01-01" max="{{date('Y-m-d')}}" class="form-control" name="date_of_issue" value="{{$degree->date_of_issue}}">
                    </div>
                    <div class="col-sm-6">
                            <label>Nước cấp<span style="color: red">*</span></label>
                            <input required type="text" maxlength="100" class="form-control" name="nation_of_issue_id" placeholder="Nhập nước cấp" value="{{$degree->nation_of_issue_id}}">
                        </div>
