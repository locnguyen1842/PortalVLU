...
@section('title','Thêm thông tin bằng cấp')
@section('breadcrumb')
        <div class="cm-flex">
            ...
            <form class="form-horizontal" action="{{route('employee.pi.degree.create')}}" method="post">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        ...
                        <input required type="date" min="1900-01-01" max="{{date('Y-m-d')}}" class="form-control" name="date_of_issue" value="{{old('date_of_issue')}}">
                    </div>
                    <div class="col-sm-6">
