...
<div class="cm-flex">
    <div class="cm-breadcrumb-container">
        <ol class="breadcrumb">
            {{-- <li><a href="#">Home</a></li> --}}
            <li class="active">Chi tiết lý lịch khoa học</li>
        </ol>
    </div>
</div>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <span for=""
                                        class="col-sm-8 text-truncate">{{($sb->getHighestDegree($pi_id)) == null ? 'Chưa có': date('Y',strtotime($sb->getHighestDegree($pi_id)->date_of_issue))}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <label for="inputEmail3" class="col-sm-4">Bằng đại học</label>
                            ...
                            @else
                            @if($loop->iteration == 1 || $loop->iteration == null)
                            <div class="form-group">
                                <div class="col-sm-6">
