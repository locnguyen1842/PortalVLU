    ...
    <div class="cm-breadcrumb-container">
        <ol class="breadcrumb">
            ...
            {{--<li class=""><a href="{{route('employee.pi.index')}}">Quản lý thông tin nhân viên</a></li>--}}
             {{--<li class=""><a href="{{route('employee.pi.detail',$pi_id)}}">Chi tiết nhân viên - {{App\PI::find($pi_id)->employee_code}}</a></li>--}}
    ...
    <div class="cm-flex">
        <div class="nav-tabs-container table-responsive">
            <ul class="nav nav-tabs">
                {{--<li class="{{url()->current() == route('employee.pi.detail',$pi_id) ? 'active':''}}"><a href="{{route('employee.pi.detail',$pi_id)}}">Thông tin cá nhân</a></li>--}}
                {{--<li class="{{url()->current() == route('employee.pi.workload.index',$pi_id) ? 'active':''}}"><a href="{{route('employee.pi.workload.index',$pi_id)}}">Khối lượng công việc</a></li>--}}
                {{--<li class="{{url()->current() == route('employee.sb.detail',$pi_id) ? 'active':''}}"><a href="{{route('employee.sb.detail',$pi_id)}}">Lý lịch khoa học</a></li>--}}
            </ul>
        </div>
    </div>
</nav>
