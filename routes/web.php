...
Route::prefix('')->group(function () {
    ...
    Route::group(['middleware'=>['auth:employee','permission:employee']], function () {
        ...
        Route::get('/faculty-detail/{id}', 'EmployeeController@getFacultydetail')->name('employee.faculty.detail');
        Route::get('/faculty-workload/{id}', 'EmployeeController@getfaWorkload')->name('employee.faculty.workload');
        Route::get('/faculty-sb/{id}', 'EmployeeController@getfacultysb')->name('employee.faculty.sb');
