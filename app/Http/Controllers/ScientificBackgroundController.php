    ...
    public function postupdateEmployeeSB(Request $request)
    {
        $request->validate(
            ...
            [
              ...
              'year_of_graduation.*.required' => 'Năm tốt không được bỏ trống',
              ...
              'doctor_year_of_issue.*.required' => 'Nơi cấp bằng tiến sĩ không được bỏ trống',
