...
class ScientificResearhWorkloadController extends Controller
{
    ...
    public function postAdd(Request $request){
        ...
        $request->validate(
            [
                'name_of_work' => 'required|max:10000',
                'detail_of_work' => 'required|max:10000',
                'explain_of_work' => 'required|max:10000',
                'unit_of_work' => 'required|max:10000',
                'note' => 'max:10000',
            ...
            [
                ...
                'name_of_work.max'=> 'Tên công việc chỉ được chứa 10000 ký tự',
                'detail_of_work.max'=> 'Chi tiết công việc chỉ được chứa 10000 ký tự',
                'explain_of_work.max'=> 'Diễn giải công việc chỉ được chứa 10000 ký tự',
                'unit_of_work.max'=> 'Đơn vị chỉ được chứa 10000 ký tự',
                'note.max'=> 'Ghi chú chỉ được chứa 10000 ký tự',
